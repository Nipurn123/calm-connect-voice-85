...
export const BottomNavigation = ({ activeTab }: BottomNavigationProps) => {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-xl bg-white/95 backdrop-blur-sm border-t border-border pb-safe-bottom">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              to={tab.path}
              className={cn(
                "flex flex-col items-center gap-1 py-2 px-2 sm:px-4 transition-colors duration-200 touch-manipulation min-h-[60px] justify-center",
